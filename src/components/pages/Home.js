    ...
    <Container maxW="xl">
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          ...
          разрабатывать web-сайты/сервисы. Со времён учёбы в школе увлекался компьютерными технологиями, уже тогда узнал, что такое HTML и CSS, в университете освоил .Net C#,
          с увлечением занимался разработкой проектов для курсовых работ, что в последствии дало возможность применить навыки в одной компании (успешно разработать, внедрить и
          поддерживать ПО для учёта талонов на питание). Также в процессе работы и в свободное время выполнял заказы на разработку несложных сайтов. С начала 2021г. изучаю
          JavaScript в том числе стек M.E.R.N., уже разработаны успешно несколько дипломных работ на заказ и несколько небольших проектов для личных нужд, или по просьбе
